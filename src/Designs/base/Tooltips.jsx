...
// export function Tooltip1({ extra }) {
//     return (
//         <div class="relative group w-max bg-red-500">
//             <button class="px-4 py-2 bg-blue-600 text-white rounded">
//                 Hover me
//             </button>

//             <div class="absolute hidden top-full left-1/2 -translate-x-1/2 mt-2 group-hover:block">
//                 <div class="relative bg-gray-900 text-white px-3 py-2 rounded">
//                     Bottom tooltip
//                     <div class="absolute left-1/2 -top-1.5 -translate-x-1/2 
...
//         //   <div class="relative bg-gray-900 text-white px-3 py-2 rounded">
//         //     Right tooltip
//         //     <div class="absolute top-1/2 -left-1.5 -translate-y-1/2 
//         //                 w-3 h-3 bg-gray-900 rotate-45"></div>
//         //   </div>
//         // </div>
//     )
...
// export function Tooltip2({ extra, textValue1, children, childrenStyle={} }) {
//     return (
     
//         <div className={`bg-black rounded-lg relative text-white w-fit px-4 py-2 ${extra}`}>
//             <div>
//                 <p className={`font-semibold mb-1 ${childrenStyle.text1}`}>{textValue1 ||'This is a tooltip'}</p>
            
//             </div>
            
//              <div className={`absolute left-1/2 -bottom-1.5 -translate-x-1/2 
//                   w-3 h-3 bg-gray-900 rotate-45 ${childrenStyle.span1}`}></div>
//         </div>
//     )
// }

// export function Tooltip3({ extra, textValue1, textValue2, children, childrenStyle={} }) {
//     return (
     
//         <div className={`bg-black rounded-lg relative text-white w-130 p-4 ${extra}`}>
//             <div>
//                 <p className={`font-semibold mb-1 ${childrenStyle.text1}`}>{textValue1 ||'This is a tooltip'}</p>
//             <span className={`text-white/70`}>
//                 {textValue2 || 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid facilis totam, deleniti ducimus quisquam voluptatibus, voluptatem cumque a aliquam quae sunt, corporis quibusdam obcaecati? Modi, explicabo ipsum? Maiores, totam doloremque.'}
//             </span>
//             </div>
...
// export function Tooltip4({ extra, textValue1, children, childrenStyle={} }) {
//     return (
     
//         <div className={`bg-black rounded-lg absolute text-white flex justify-center-safe items-center-safe w-fit ${extra}`}>
//             <div>
//                 <p className={`font-semibold ${childrenStyle.text1}`}>{textValue1 ||'This is a tooltip'}</p>
