...
// export function CheckBox1({ extra, icon: Icon1 }) {
//     return (
//         <div>
//             <label className="flex items-center w-fit space-x-2 cursor-pointer">
//                 <div className="relative ">
//                     <input type="checkbox" className="sr-only peer" />
//                     <div className={`w-6 h-6 bg-white border-2 border-gray-400 rounded-md peer-checked:bg-blue-600 peer-checked:border-blue-600 transition-colors ${extra}`}></div>
//                     {Icon1 || <svg className="absolute w-4 h-4 text-white top-1 left-1 hidden peer-checked:block" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="5" d="M5 13l4 4L19 7"></path></svg>}
//                 </div>
//             </label>
//         </div>
//     )
...
// export function CheckBox2({ extra, icon: Icon1 }) {
//     return (
//         <div>
//             <label className="flex items-center w-fit space-x-2 cursor-pointer">
//                 <div className="relative ">
//                     <input type="checkbox" className="sr-only peer" />
//                     <div className={`w-6 h-6 bg-white border-2 border-gray-400 rounded-md peer-checked:bg-blue-600 peer-checked:border-blue-600 transition-colors ring-2 ring-blue-600 ring-offset-2 ${extra}`}></div>
//                     {Icon1 || <FaMinus className="absolute w-4 h-4 text-white top-1 left-1 hidden peer-checked:block" />}
//                 </div>
//             </label>
//         </div>
//     )
...
// export function CheckBox3({ extra, icon: Icon1 }) {
//     return (
//         <div>
//             <label className="flex items-center w-fit space-x-2 cursor-pointer">
//                 <div className="relative ">
//                     <input type="checkbox" disabled className="sr-only peer" />
//                     <div className={`w-6 h-6 bg-black/7 border-2 border-gray-300 rounded-md ${extra}`}></div>
//                     {Icon1 || <FaMinus className="absolute w-4 h-4 text-black/30 top-1 left-1 hidden peer-checked:block" />}
//                 </div>
//             </label>
//         </div>
//     )
...
// export function CheckBox4({ extra, icon: Icon1 }) {
//     return (
//         <div>
//             <label className="flex items-center w-fit space-x-2 cursor-pointer">
//                 <div className="relative ">
//                     <input type="checkbox" disabled className="sr-only peer" />
//                     <div className={`w-6 h-6 bg-black/7 border-2 border-gray-300 rounded-md ${extra}`}></div>
//                     {Icon1 || <FaMinus className="absolute w-4 h-4 text-black/30 top-1 left-1  peer-checked:block" />}
//                 </div>
//             </label>
//         </div>
//     )
...
// export function CheckBox5({ extra }) {
//     return (
//          <div>
//             <label className="flex items-center w-fit space-x-2 cursor-pointer">
//                 <div className="relative">
//                     <input type="radio" className="sr-only peer" />
//                     <div className={`w-6 h-6 rounded-full  border-1 border-gray-400 bg-white peer-checked:bg-blue-600 peer-checked:border-blue-600 ${extra}`}></div>
...
// export function CheckBox6({ extra }) {
//     return (
//         <div>
//             <label className="flex items-center w-fit space-x-2 cursor-pointer">
//                 <div className="relative ">
//                     <input type="radio" className="sr-only peer" />
//                     <div className={`w-6 h-6 rounded-full bg-white border-2 border-gray-400 peer-checked:bg-blue-600 peer-checked:border-blue-600 ring-2 ring-blue-500 ring-offset-2 ${extra}`}></div>
...
// export function CheckBox7({ extra }) {
//     return (
//         <div>
//             <label className="flex items-center w-fit space-x-2 cursor-pointer">
//                 <div className="relative ">
//                     <input type="radio" disabled className="sr-only peer" />
//                     <div className={`w-6 h-6 rounded-full bg-black/5 border-2 border-gray-400 peer-checked:bg-black ${extra}`}></div>
...
// export function CheckBoxWithText1({extra, textValue1, textValue2, ToggleTag, children, childrenStyle={}}){
//     return(
//         <div className={`flex gap-2 ${extra}`}>
//            {children || <> {ToggleTag || <CheckBox1/>}
//             <div>
