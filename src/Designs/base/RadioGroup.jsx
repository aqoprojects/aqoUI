...
// export function RadioGroupItem1({ extra, children }) {
//   return (
//     <div className='flex items-start gap-3 ring-2 ring-black/10 w-fit p-3 rounded-xl'>
//         <Avatar3 icon={RxStack} extra={'rounded-md bg-white ring-1 ring-black/40 !w-7 !h-7 !p-1 '} />

//         <div className='flex-1 leading-none'>
//           <p className='font-semibold text-black/50 '>Basic plan <span className='font-normal text-sm'>$10/month</span></p>
//           <p className='text-black/50 text-sm'>Includes up to 10 users, 20 GB individual data and access to all features.</p>
//         </div>
//       <CheckBox1 extra={'!w-4 !h-4'} />
//     </div>
//   )
// }
...
// export function RadioGroupItem2({ extra, children }) {
//   return (
//     <div className='flex items-start gap-3 border-1 border-black/10 ring-1 ring-purple-800 ring-offset-3 w-fit p-3 rounded-xl'>
//         <Avatar3 icon={RxStack} extra={'rounded-md bg-white ring-1 ring-black/40 !w-7 !h-7 !p-1 '} />
...
//           <p className='text-black/50 text-sm'>Includes up to 10 users, 20 GB individual data and access to all features.</p>
//         </div>
//       <CheckBox1 extra={'!w-4 !h-4 !rounded-sm ring-1 ring-purple-800 ring-offset-2  !border-1'} />
//     </div>
//   )
// }


// export function RadioGroupItem3({extra, children}) {
//   return (
//     <div  className='flex flex-col border-1 border-black/10  rounded-xl  max-w-170'>
//       <div  className='flex items-center-safe justify-between gap-2 border-b-1 p-4 border-black/10'>
//           <div className='flex gap-2 items-center-safe'>
//             <Avatar3 icon={RxStack} extra={'rounded-md bg-white ring-1 ring-black/40 !w-7 !h-7 !p-1 '} />
            
//             <div className='flex-1 leading-none'>
//               <p className='font-semibold text-black/50 '>Basic plan </p>
//             </div>
//           </div>
//         <CheckBox1 extra={'!w-4 !h-4 !rounded-sm  !border-1'} />
//       </div>

//       <div className='flex justify-between items-start p-4 flex-col md:flex-row gap-2'>
//         <div className='flex flex-col gap-2 order-last md:order-first'>
//           <p className='text-4xl font-bold'>$10 <span className='text-sm font-normal text-black/40'>per month</span></p>
//           <p className='text-black/50 text-sm'>Includes up to 10 users, 20 GB individual data and access to all features.</p>
//         </div>
...
// export function RadioGroupItem4({extra, children}) {
//   return (
//     <div  className='flex flex-col border-1 border-black/10  rounded-xl  max-w-170 ring-2 ring-purple-600 ring-offset-2'>
//       <div  className='flex items-center-safe justify-between gap-2 border-b-1 p-4 border-black/10'>
//           <div className='flex gap-2 items-center-safe'>
//             <Avatar3 icon={RxStack} extra={'rounded-md bg-white ring-1 ring-black/40 !w-7 !h-7 !p-1 '} />
...
// export function RadioGroupItem5({extra, children}) {
//   return (
//     <div className='flex items-start justify-between max-w-160 border-2 border-black/10 p-3 rounded-xl'>
//       <div className='flex items-center-safe gap-3'>
//         <Avatar1 extra={'!w-10 !h-10'}/>
//         <div>
//           <p className='font-semibold'>Shola Adele <span className='font-medium text-black/40 text-md'>@Shola</span> </p>
//           <p className='font-semibold text-black/40'>Product Manager, Integrations</p>
//         </div>
//       </div>
//       <CheckBox1 extra={'!w-5 !h-5 !border-2 !border-black/20'} />
//     </div>
//   )
// }
...
// export function RadioGroupItem6({extra, children}) {
//   return (
//     <div className='flex items-start justify-between max-w-160 border-2 border-black/10 p-3 rounded-xl ring-1 ring-purple-600 ring-offset-2'>
//       <div className='flex items-center-safe gap-3'>
//         <Avatar1 extra={'!w-10 !h-10'}/>
//         <div>
//           <p className='font-semibold'>Shola Adele <span className='font-medium text-black/40 text-md'>@Shola</span> </p>
...
//         </div>
//       </div>
//       <CheckBox1 extra={'!w-5 !h-5 !border-2 !border-black/20 ring-1 ring-purple-600 ring-offset-1'} />
//     </div>
//   )
// }
...
// export function RadioGroupItem7({extra, children}) {
//   return (
//     <div className='flex items-start justify-between max-w-160 border-2 border-black/10 p-4 rounded-xl'>
//       <div className='flex items-start gap-5 '>
//         <Avatar3 extra={'bg-white text-indigo-800 !w-10 !h-8 !p-0 ring-1 ring-black/40 rounded-md '} icon={SiVisa}/>
//         <div>
//           <p className='font-bold text-black/50'>Visa ending in 1234 </p>
//           <p className='font-medium text-black/40'>Expiry 06/2028</p>
//           <div className='flex items-center-safe gap-2 font-semibold text-black/40 mt-2'>
//             <p>Set as defalt</p> 
//              <Button4 extra={'bg-transparent !text-indigo-400 !w-fit !p-0'} textValue={'Edit'} childrenStyle={{text1: '!text-base', icon1: 'hidden'}} />
//           </div>
//         </div>
//       </div>
//       <CheckBox1 extra={'!w-5 !h-5 !border-2 !border-black/20 '} />
...
// export function RadioGroupItem8({extra, children}) {
//   return (
//     <div className='flex items-start justify-between max-w-160 border-2 border-black/10 p-4 rounded-xl ring-1 ring-purple-600 ring-offset-1'>
//       <div className='flex items-start gap-5 '>
//         <Avatar3 extra={'bg-white text-indigo-800 !w-10 !h-8 !p-0 ring-1 ring-black/40 rounded-md '} icon={SiVisa}/>
//         <div>
//           <p className='font-bold text-black/50'>Visa ending in 1234 </p>
...
// export function RadioGroupItem9({ extra, children }) {
//   return (
//     <div className='flex items-start gap-3 ring-2 ring-black/10 w-fit p-3 rounded-xl'>
       
//       <CheckBox5 extra={'!w-4 !h-4 !rounded-full '} />
...
// export function RadioGroupItem10({ extra, children }) {
//   return (
//     <div className='flex items-start gap-3 border-2 border-black/10 w-fit p-3 rounded-xl ring-1 ring-purple-600 ring-offset-2'>
       
//       <CheckBox5 extra={'!w-3 !h-3 !rounded-full ring-1 ring-purple-600 ring-offset-2 '} />
...
// export function RadioGroupItem11({extra, children}) {
//   return (
//     <div className='flex items-start justify-between max-w-160 border-2 border-black/10 p-4 rounded-xl'>
//       <div className='flex items-start gap-5 '>
//         <Avatar3 extra={'bg-white text-indigo-800 !w-10 !h-8 !p-0 ring-1 ring-black/40 rounded-md '} icon={SiVisa}/>
