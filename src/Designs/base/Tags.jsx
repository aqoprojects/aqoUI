...
// export function Tag1({extra, textValue, childrenStyle = {}, children,}){
//     return (
//     <label className={`${extra} px-2 w-fit py-0.5 ring-2 ring-gray-200 rounded-md`}>
//       {children ||  <span className={`${childrenStyle.text} font-semibold`}>{textValue || 'Label'}</span>}
//     </label>
//     )
// }

// export function Tag2({extra, textValue, childrenStyle = {}, children, icon: Icon1 = IoClose}){
//     return (
//     <label className={`${extra} w-fit flex gap-2 items-center-safe px-2 py-0.5 ring-2 ring-gray-200 rounded-md`}>
//       {children || <>  <span className={`${childrenStyle.text} font-semibold`}>{textValue || 'Label'}</span>

//       {/* --------------------------- */}
//     <Icon1 className={`${childrenStyle.icon1} size-4 fill-gray-400`}/></>}
//     </label>
//     )
// }
...
// export function Tag3({extra, textValue, childrenStyle = {}, children}){
//     return (
//     <label className={`${extra} w-fit flex gap-2 items-center-safe pl-2 pr-0.5 py-0.5 ring-2 ring-gray-200 rounded-md`}>
//         {children || <><span className={`${childrenStyle.text} font-semibold`}>{textValue || 'Label'}</span>
//         {/* ------------------------ */}
//          <div className='w-fit px-2 bg-gray-200 rounded-md'>
...
// export function Tag4({extra, textValue, childrenStyle = {}, children}){
//     return (
//     <div className='w-fit flex gap-2 items-center-safe pl-2 pr-0.5 py-0.5 ring-2 ring-gray-200 rounded-md '>
//           <label className="flex items-center w-fit space-x-2 cursor-pointer">
//             <div className="relative ">
//                 <input type="checkbox" className="sr-only peer" />
//                 <div className="w-5 h-5 bg-white border-2 border-gray-400 rounded-md peer-checked:bg-blue-600 peer-checked:border-blue-600 transition-colors"></div>
...
//         <span className='font-semibold'>Label</span>
//          <div className='w-5 h-5'>
//             <MdClose className='size-full fill-gray-400' />
//         </div>
//     </div>
//     )
// }
...
//             <img src="/public/image.jpg" className='w-full object-cover h-full rounded-full' />
//           </div>
//         <span className='font-semibold'>Label</span>
//          <div className='w-5 h-5'>
//             <MdClose className='size-full fill-gray-400' />
...
//           </div>
//         <span className='font-semibold'>Label</span>
//          <div className='w-fit px-2 bg-gray-200 rounded-sm'>
//             <p className='text-md font-semibold'>5</p>
//         </div>
//     </div>
//     )
...
//     <div className='w-fit flex gap-2  items-center-safe pl-2 pr-0.5 py-0.5 ring-2 ring-gray-200 rounded-md '>
//           <div className='w-3 h-5 rounded-full'>
//             <GoDotFill className='size-5 fill-green-500'/>
//           </div>
//         <span className='font-semibold'>Label</span>
//     </div>
//     )
...
//             <MdClose className='size-full fill-gray-300' />
//         </div>
//     )
// }
...
// export function TagClose2() {
//     return (
//         <div className='w-10 h-10 p-1 bg-black/4 rounded-lg'>
//             <MdClose className='size-full fill-gray-300' />
//         </div>
//     )
// }
...
// export function TagClose3() {
//     return (
//         <div className='w-10 h-10 p-1 bg-red-300 rounded-full'>
//             <MdClose className='size-full fill-gray-300' />
//         </div>
//     )
// }
...
// export function TagCount1({extra, textValue, children, childrenStyle = {}}) {
//     return (
//         <div className={`w-fit px-3 py-0.5 bg-gray-200 rounded-md ${extra}`}>
//             {children || <p className={`text-3xl font-semibold ${childrenStyle.text1}`}>{textValue || 5}</p>}
//         </div>
//     )
// }


// export function TagCheckbox1() {
//     return (
       
//         <input type="checkbox" name="checkbox" className="rounded-3xl size-7 accent-purple-800 outline-none " />

//     )
// }

// export function TagCheckbox2() {
//     return (
      
//         <input type="checkbox" name="checkbox" className="rounded-3xl size-7 accent-purple-800 outline-2 outline-offset-2 outline-purple-600" />

//     )
// }

// export function TagCheckbox3() {
//     return (
//         <label className="flex items-center w-fit space-x-2 cursor-pointer">
//             <div className="relative ">
//                 <input type="checkbox" className="sr-only peer" />
//                 <div className="w-6 h-6 bg-white border-2 border-gray-400 rounded-md peer-checked:bg-blue-600 peer-checked:border-blue-600 transition-colors"></div>
//                 <svg className="absolute w-4 h-4 text-white top-1 left-1 hidden peer-checked:block" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="5" d="M5 13l4 4L19 7"></path></svg>
//             </div>
//         </label>
//     )
// }

// export function TagCheckbox4() {
//     return (
//         <label className="flex items-center w-fit space-x-2 cursor-pointer">
//             <div className="relative">
//                 <input type="checkbox" className="sr-only peer" />
//                 <div className="w-6 h-6 bg-white border-2 border-gray-400 rounded-md peer-checked:bg-blue-600 peer-checked:border-blue-600 transition-colors outline-2 outline-blue-700 outline-offset-2"></div>
//                 <svg className="absolute w-4 h-4 text-white top-1 left-1 hidden peer-checked:block" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="5" d="M5 13l4 4L19 7"></path></svg>
//             </div>
//         </label>
//     )
...
// export function TagCheckbox5() {
//     return (
//         <label className="flex items-center w-fit space-x-2 cursor-pointer">
//             <div className="relative ">
//                 <input type="checkbox" className="sr-only peer" />
//                 <div className="w-6 h-6 bg-gray-100 border-2 border-gray-400 rounded-md peer-checked:bg-gray-100 peer-checked:border-gray-400 transition-colors"></div>
//                 <svg className="absolute w-4 h-4 text-gray-400 top-1 left-1 hidden peer-checked:block" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="5" d="M5 13l4 4L19 7"></path></svg>
//             </div>
//         </label>
//     )
// }
