...
// export function ProgressBar1({ extra, children, childrenStyle = {} }) {
//     return (
//         <div className={`bg-black/20 w-100 h-2.5 rounded-xl ${extra}`}>
//             <div className={`bg-purple-600 w-40 h-full rounded-xl ${childrenStyle.span1}`}></div>
//         </div>
//     )
// }


// export function ProgressBar2({ extra, children, childrenStyle = {} }) {
//     return (
...
// export function ProgressBar3({ extra, children, childrenStyle = {} }) {
//     return (
//         <div className='flex items-center-safe gap-3 relative w-fit h-10'>
//             <Tooltip4 textValue1={'60%'}  extra={'bg-white !text-black shadow-black shadow-sm/30 !px-3 !py-1 right-50 -top-7'}/>
//             <div className={`bg-black/20 w-100 h-2.5 rounded-xl ${extra}`}>
//                 <div className={`bg-purple-600 w-40 h-full rounded-xl ${childrenStyle.span1}`}></div>
//             </div>
//         </div>
...
// export function ProgressCircle1({ extra, children, childrenStyle = {} }) {
//     return (
...
//       className="text-blue-600 fill-none transition-all duration-500"
...
// export function ProgressCircle2({ extra, children, childrenStyle = {} }) {
//     return (
//         <div className="relative w-32 h-32">
            
//   <svg className="w-full h-full rotate-[-30deg]">
//     <circle
//       cx="50%"
//       cy="50%"
//       r="45%"
...
// export function ProgressHalfCircle({ extra, children, childrenStyle = {} }) {
//   // Circle radius
//   const radius = 45;
//   const circumference = 2 * Math.PI * radius; // Full circle circumference
//   const halfCircumference = circumference / 2; // Only top half

//   // Progress in percentage
//   const progress = 50; // Example
//   const offset = halfCircumference * (1 - progress / 100);

//   return (
//     <div className="relative w-52 h-36 overflow-hidden"> {/* half height */}
...
//       {/* Centered text */}
//       <div
//         className="absolute inset-0 flex flex-col items-center text-xl font-semibold"
//         style={{ top: "0", transform: "translateY(50%)" }} // adjust for half height
//       >
//         <p className='text-sm text-black/50'>Active users</p>
